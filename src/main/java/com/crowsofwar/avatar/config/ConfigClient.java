...
public class ConfigClient {
    ...
    public static class ActiveBendingSettings {
        ...
        @Load
        public int middleXPosition = 0, rightXPosition = 50, leftXPosition = -35;
        //The x pos of the middle/active bending, the bending icon on the right, and the bending icon on the left

        @Load
        public int middleYPosition = -30, rightYPosition = 5, leftYPosition = 5;
        //The xp pos of the bending icon on the left

        @Load
        public float middleBendingWidth = 50, leftBendingWidth = 35, rightBendingWidth = 35;

        @Load
        public float middleBendingHeight = 50, leftBendingHeight = 35, rightBendingHeight = 35;
    ...
    public static class ChiBarSettings {
        ...
        @Load
        public double widthScale = 1.1F, heightScale = 1.1F;

        @Load
        public int xPos = 115, yPos = 3;
    ...
    public static class FireRenderSettings {
        ...
        @Load
        public int fireR = 255, fireG = 50, fireB = 10;

        //Only used for supporters
        @Load
        public int lightningR = 135, lightningG = 255, lightningB = 252;
