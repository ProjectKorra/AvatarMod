...
public class EntityKiBall extends EntityOffensive {

    private static final DataParameter<Boolean> SYNC_SLOWS = EntityDataManager.createKey(EntityKiBall.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SYNC_DESTROYS = EntityDataManager.createKey(EntityKiBall.class,
            DataSerializers.BOOLEAN);
    ...
    public EntityKiBall(World world) {
        super(world);
        setSize(1f, 1f);
        putsOutFires = true;
        this.noClip = true;
