...
public class EntityAbyssBall extends EntityOffensive {

    private static final DataParameter<Boolean> SYNC_SLOWS = EntityDataManager.createKey(EntityAbyssBall.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SYNC_DESTROYS = EntityDataManager.createKey(EntityAbyssBall.class,
            DataSerializers.BOOLEAN);
    ...
    public EntityAbyssBall(World world) {
        super(world);
        setSize(1f, 1f);
        putsOutFires = true;
        this.noClip = true;
