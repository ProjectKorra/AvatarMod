...
public class EntityIceLance extends EntityOffensive {
    ...
    private static final DataParameter<Boolean> SYNC_SLOWS = EntityDataManager.createKey(EntityIceLance.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SYNC_DESTROYS = EntityDataManager.createKey(EntityIceLance.class,
            DataSerializers.BOOLEAN);
    ...
    public SoundEvent[] getSounds() {
        ...
        events[1] = SoundEvents.BLOCK_GLASS_BREAK;
        return events;
    }
