...
public class EntityInfernalBall extends EntityOffensive {

    private static final DataParameter<Boolean> SYNC_SLOWS = EntityDataManager.createKey(EntityInfernalBall.class,
            DataSerializers.BOOLEAN);
    private static final DataParameter<Boolean> SYNC_DESTROYS = EntityDataManager.createKey(EntityInfernalBall.class,
            DataSerializers.BOOLEAN);
    ...
    public EntityInfernalBall(World world) {
        super(world);
        setSize(1f, 1f);
        putsOutFires = true;
        this.noClip = true;
...
//        }
    ...
    public SoundEvent[] getSounds() {
        ...
        events[0] = SoundEvents.ENTITY_ENDERMEN_DEATH;
        return events;
    }
