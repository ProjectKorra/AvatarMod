...
import static com.crowsofwar.avatar.util.data.StatusControlController.PULL_WALL;
...
public abstract class WallBehavior extends Behavior<EntityWallSegment> {
    ...
    public static class Rising extends WallBehavior {
        ...
        public WallBehavior onUpdate(EntityWallSegment entity) {
            ...
            return (ticks > Math.sqrt(entity.getSegmentHeight()) * 50
                    ...
                    + 0.25 <= entity.getPositionVector().y) || entity.velocity().y() < 0.05 && ticks > 4
                    ? new Waiting() : this;
        }
    ...
    public static class Push extends WallBehavior {
        ...
        public WallBehavior onUpdate(EntityWallSegment entity) {
            ...
            if (entity == null || entity.getOwner() == null) return this;
            if (entity.getWall() == null) return this;
            ...
            if (ticks == 1) {
                ...
                if (wall != null && abilityData != null)
                    BendingData.get(entity.getOwner()).chi().consumeChi(wall.getChiCost(abilityData) / 2);
            } else {
