...
public abstract class AvatarParticle extends EntityFX {
	...
	public AvatarParticle(World world, double x, double y, double z, double motionX, double motionY, double motionZ) {
	...
	public void renderParticle(Tessellator t, float p_70539_2_, float p_70539_3_, float p_70539_4_, float p_70539_5_, float p_70539_6_,
			float p_70539_7_) {
		t.draw();
