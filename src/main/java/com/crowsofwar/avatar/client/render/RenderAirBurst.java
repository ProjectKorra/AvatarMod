...
public class RenderAirBurst extends Render<EntityAirBurst> {
	 ...
	 * @param renderManager
	 */
	public RenderAirBurst(RenderManager renderManager) {
		super(renderManager);
	}

	@Override
	public void doRender(EntityAirBurst entity, double xx, double yy, double zz, float entityYaw,
						 float partialTicks) {
