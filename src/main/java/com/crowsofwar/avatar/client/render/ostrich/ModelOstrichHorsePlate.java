...
public class ModelOstrichHorsePlate extends ModelOstrichHorse {
	...
	private ModelRenderer saddle10;
	...
	private ModelRenderer Armortier2body1;
	private ModelRenderer Armortier2body2;
	private ModelRenderer Armortier2body3;
	private ModelRenderer Armortier3body1;
	private ModelRenderer Armortier3body2;
	private ModelRenderer Armortier3body3;
	private ModelRenderer Armortier3body4;
	private ModelRenderer Armortier3body5;
	...
	private ModelRenderer Armortier2neck1;
	private ModelRenderer Armortier2neck2;
	private ModelRenderer Armortier2neck3;
	private ModelRenderer Armortier2neck4;
	private ModelRenderer Armortier3head;
	...
	private ModelRenderer Armortier3lags4;
	private ModelRenderer Armortier3lags3;
	private ModelRenderer Armortier2lags2;
	private ModelRenderer Armortier2lags1;
	...
	private ModelRenderer Armortier2lags3;
	private ModelRenderer Armortier2lags4;
	private ModelRenderer Armortier3lags1;
	private ModelRenderer Armortier3lags2;

	public ModelOstrichHorsePlate() {
		...
		this.Armortier2lags3 = new ModelRenderer(this, 0, 20);
		this.Armortier2lags3.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2lags3.addBox(-3.5F, 10.0F, 0.2F, 3, 7, 2, 0.0F);
		this.setRotateAngle(Armortier2lags3, -0.5235987755982988F, -0.0F, 0.0F);
		...
		this.Rleg.addBox(-4.0F, -2.5F, -4.0F, 4, 6, 8, 0.0F);
		...
		this.Armortier3head = new ModelRenderer(this, 70, 12);
		this.Armortier3head.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier3head.addBox(-2.5F, -14.5F, -3.0F, 6, 5, 8, 0.0F);
		this.setRotateAngle(Armortier3head, 0.2617993877991494F, -0.0F, 0.0F);
		...
		this.Armortier2neck1 = new ModelRenderer(this, 16, 19);
		this.Armortier2neck1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2neck1.addBox(-2.0F, -10.0F, 0.0F, 5, 3, 2, 0.0F);
		this.setRotateAngle(Armortier2neck1, 0.5235987755982988F, -0.0F, 0.0F);
		...
		this.MainTail.setRotationPoint(-1.5F, -0.8F, 11.0F);
		this.MainTail.addBox(0.0F, 0.0F, 0.0F, 3, 8, 3, 0.0F);
		this.Armortier2neck4 = new ModelRenderer(this, 16, 19);
		this.Armortier2neck4.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2neck4.addBox(-2.5F, -6.5F, -2.8F, 6, 5, 2, 0.0F);
		...
		this.saddle10 = new ModelRenderer(this, 69, 45);
		this.saddle10.setRotationPoint(-5.0F, -6.5F, 5.5F);
		this.saddle10.addBox(0.0F, 0.0F, 0.0F, 10, 3, 3, 0.0F);
		...
		this.Armortier3lags2 = new ModelRenderer(this, 27, 1);
		this.Armortier3lags2.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier3lags2.addBox(-4.0F, 4.0F, -2.8F, 4, 2, 5, 0.0F);
		...
		this.neck2.addBox(-1.5F, -11.4F, -0.8F, 4, 5, 5, 0.0F);
		...
		this.Armortier3body5 = new ModelRenderer(this, 74, 0);
		this.Armortier3body5.setRotationPoint(-8.5F, -0.5F, -12.800000190734863F);
		this.Armortier3body5.addBox(0.0F, 0.0F, 0.0F, 1, 5, 7, 0.0F);
		...
		this.Armortier3lags4 = new ModelRenderer(this, 27, 1);
		this.Armortier3lags4.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier3lags4.addBox(0.0F, 4.0F, -2.8F, 4, 2, 5, 0.0F);
		...
		this.Lleg.addBox(0.0F, -2.5F, -4.0F, 4, 6, 8, 0.0F);
		this.setRotateAngle(Lleg, 0.2617993877991494F, 0.0F, 0.0F);
		this.Armortier2body2 = new ModelRenderer(this, 16, 19);
		this.Armortier2body2.setRotationPoint(-6.0F, -0.5F, -14.699999809265137F);
		this.Armortier2body2.addBox(0.0F, 0.0F, 0.0F, 12, 5, 1, 0.0F);
		...
		this.Armortier3body4 = new ModelRenderer(this, 74, 0);
		this.Armortier3body4.setRotationPoint(-6.0F, -0.5F, -14.5F);
		this.Armortier3body4.addBox(0.0F, 0.0F, 0.0F, 1, 5, 3, 0.0F);
		this.setRotateAngle(Armortier3body4, 0.0F, -0.9948377013206482F, 0.0F);
		...
		this.Armortier2neck2 = new ModelRenderer(this, 16, 19);
		this.Armortier2neck2.setRotationPoint(-3.0F, -10.0F, -14.0F);
		this.Armortier2neck2.addBox(0.5F, 5.0F, 9.5F, 6, 1, 7, 0.0F);
		this.setRotateAngle(Armortier2neck2, 0.17453292519943295F, -0.0F, 0.0F);
		...
		this.Armortier2lags1 = new ModelRenderer(this, 0, 20);
		this.Armortier2lags1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2lags1.addBox(0.5F, 12.0F, 2.2F, 3, 3, 2, 0.0F);
		this.setRotateAngle(Armortier2lags1, -0.5235987755982988F, -0.0F, 0.0F);
		...
		this.Armortier3body1 = new ModelRenderer(this, 45, 3);
		this.Armortier3body1.setRotationPoint(-5.5F, 7.5F, -11.699999809265137F);
		this.Armortier3body1.addBox(0.0F, 0.0F, 0.0F, 11, 5, 1, 0.0F);
		this.setRotateAngle(Armortier3body1, 1.3089969158172607F, -0.0F, 0.0F);
		this.Armortier3body3 = new ModelRenderer(this, 74, 0);
		this.Armortier3body3.setRotationPoint(7.300000190734863F, -0.5F, -12.800000190734863F);
		this.Armortier3body3.addBox(0.0F, 0.0F, 0.0F, 1, 5, 7, 0.0F);
		...
		this.Armortier3lags1 = new ModelRenderer(this, 27, 1);
		this.Armortier3lags1.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier3lags1.addBox(-4.1F, 1.5F, -4.8F, 4, 7, 2, 0.0F);
		...
		this.Armortier2body3 = new ModelRenderer(this, 16, 19);
		this.Armortier2body3.setRotationPoint(-5.5F, 4.5F, -14.699999809265137F);
		this.Armortier2body3.addBox(0.0F, 0.0F, 0.0F, 11, 5, 1, 0.0F);
		this.setRotateAngle(Armortier2body3, 0.7330383062362671F, -0.0F, 0.0F);
		...
		this.Armortier2neck3 = new ModelRenderer(this, 16, 19);
		this.Armortier2neck3.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2neck3.addBox(-2.5F, -2.0F, -3.8F, 6, 1, 7, 0.0F);
		this.setRotateAngle(Armortier2neck3, 0.17453292519943295F, -0.0F, 0.0F);
		...
		this.Armortier3lags3 = new ModelRenderer(this, 27, 1);
		this.Armortier3lags3.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier3lags3.addBox(0.1F, 1.5F, -4.8F, 4, 7, 2, 0.0F);
		...
		this.Armortier3body2 = new ModelRenderer(this, 74, 0);
		this.Armortier3body2.mirror = true;
		this.Armortier3body2.setRotationPoint(5.5F, -0.5F, -14.300000190734863F);
		this.Armortier3body2.addBox(-0.5F, 0.0F, 0.0F, 1, 5, 3, 0.0F);
		this.setRotateAngle(Armortier3body2, 0.0F, 0.9948377013206482F, 0.0F);
		...
		this.Armortier2body1 = new ModelRenderer(this, 16, 19);
		this.Armortier2body1.setRotationPoint(-5.5F, -5.0F, -13.0F);
		this.Armortier2body1.addBox(0.0F, -0.2F, 0.5F, 11, 5, 1, 0.0F);
		this.setRotateAngle(Armortier2body1, -0.47123889803846897F, -0.0F, 0.0F);
		...
		this.Armortier2lags4 = new ModelRenderer(this, 0, 20);
		this.Armortier2lags4.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2lags4.addBox(-3.5F, 12.0F, 2.2F, 3, 3, 2, 0.0F);
		this.setRotateAngle(Armortier2lags4, -0.5235987755982988F, -0.0F, 0.0F);
		...
		this.Armortier2lags2 = new ModelRenderer(this, 0, 20);
		this.Armortier2lags2.setRotationPoint(0.0F, 0.0F, 0.0F);
		this.Armortier2lags2.addBox(0.5F, 10.0F, 0.2F, 3, 7, 2, 0.0F);
		this.setRotateAngle(Armortier2lags2, -0.5235987755982988F, -0.0F, 0.0F);
		...
		this.neck1.addChild(this.Armortier2neck4);
		this.Lleg.addChild(this.Llcrawl1);
		this.Rleg.addChild(this.Armortier3lags2);
		...
		this.Lleg.addChild(this.Armortier3lags4);
		...
		this.neck1.addChild(this.Armortier2neck2);
		this.Lleg.addChild(this.Armortier2lags1);
		this.MainTail.addChild(this.tail3);
		this.neck1.addChild(this.beak2);
		this.Rleg.addChild(this.Armortier3lags1);
		...
		this.neck1.addChild(this.Armortier2neck3);
		this.MainTail.addChild(this.tail7);
		this.Lleg.addChild(this.Armortier3lags3);
		...
		this.Rleg.addChild(this.Armortier2lags4);
		this.Lleg.addChild(this.Armortier2lags2);
	...
	public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5) {
		...
		this.Armortier3body2.render(f5);
		this.Armortier2body1.render(f5);
