...
public class RenderLlibraryLemur extends RenderLiving<EntityFlyingLemur>{
	...
	public RenderLlibraryLemur(RenderManager manager) {
		super(manager, new ModelLlibraryLemur(), 0.2F);
	}
	...
	public static class RenderFactory implements IRenderFactory<EntityFlyingLemur> {
        ...
        public Render<? super EntityFlyingLemur> createRenderFor(RenderManager manager) {
            return new RenderLlibraryLemur(manager);
        }
