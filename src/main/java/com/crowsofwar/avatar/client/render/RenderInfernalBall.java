...
public class RenderInfernalBall extends Render<EntityInfernalBall> {

    public RenderInfernalBall(RenderManager renderManager) {
        super(renderManager);
    }

    //Copied from the forcefield class
    @Override
    public void doRender(@Nonnull EntityInfernalBall entity, double x, double y, double z, float entityYaw, float partialTicks) {
        ...
        float r = 120 / 255F, g = 36 / 255F + 0.025f * pulse, b = 48 / 255F;
    ...
    @Nullable
    @Override
    protected ResourceLocation getEntityTexture(@Nonnull EntityInfernalBall entity) {
        return null;
    }
}