...
public class RenderAscendedLlibraryLemur extends RenderLiving<EntityAscendedFlyingLemur>{
	...
	public RenderAscendedLlibraryLemur(RenderManager manager) {
		super(manager, new ModelLlibraryLemur(), 0.20F);
	...
	public static class RenderFactory implements IRenderFactory<EntityAscendedFlyingLemur> {
        ...
        public Render<? super EntityAscendedFlyingLemur> createRenderFor(RenderManager manager) {
            return new RenderAscendedLlibraryLemur(manager);
        }
