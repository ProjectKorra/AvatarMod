...
public class GliderInfo {
    ...
    public static final String itemGliderBasicName = "hang_glider_basic";
    public static final String itemGliderAdvancedName = "hang_glider_advanced";
    ...
    public static final String itemGliderPartName = "hang_glider_part";
