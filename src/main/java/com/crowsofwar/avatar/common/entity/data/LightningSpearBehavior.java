...
public abstract class LightningSpearBehavior extends Behavior<EntityLightningSpear> {
        ...
        public static void register() {
            ...
            ID_NOTHING = registerBehavior(LightningSpearBehavior.Idle.class);
            ID_PLAYER_CONTROL = registerBehavior(LightningSpearBehavior.PlayerControlled.class);
            ID_THROWN = registerBehavior(LightningSpearBehavior.Thrown.class);
        }
        ...
        public static class PlayerControlled extends LightningSpearBehavior {
            ...
            public LightningSpearBehavior onUpdate(EntityLightningSpear entity) {
                ...
                if (data.getAbilityData("lightning_spear").isMasterPath(AbilityData.AbilityTreePath.SECOND)) {
