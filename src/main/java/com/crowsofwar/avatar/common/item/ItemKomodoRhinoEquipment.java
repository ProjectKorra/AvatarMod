 ...
 * @author CrowsOfWar
 */
public class ItemKomodoRhinoEquipment extends Item implements AvatarItem {

    public ItemKomodoRhinoEquipment() {
        setTranslationKey("komodorhino_equip");
        setMaxStackSize(1);
    ...
    public String getModelName(int meta) {
        return "komodorhino_equip_" + EquipmentTier.getTierName(meta);
    }
