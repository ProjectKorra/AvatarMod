...
public class ParticleCollideEvent extends EntityEvent {
	...
	public ParticleCollideEvent(Entity entity, ParticleAvatar particle, Entity spawner, UUID bendingID, Vec3d velocity) {
		super(entity);
	...
	public ParticleCollideEvent(Entity entity, ParticleAvatar particle, Entity spawner, Ability ability, Vec3d velocity) {
		super(entity);
		this.particle = particle;
		this.spawner = spawner;
