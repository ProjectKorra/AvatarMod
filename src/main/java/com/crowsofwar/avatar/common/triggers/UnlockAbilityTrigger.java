 ...
 * @author jabelar
 */
public class UnlockAbilityTrigger implements ICriterionTrigger<UnlockAbilityTrigger.Instance>
{
    private final ResourceLocation RL;
    private final Map<PlayerAdvancements, UnlockAbilityTrigger.Listeners> listeners = Maps.newHashMap();
     ...
     */
    public UnlockAbilityTrigger(String parString)
    {
        super();
     ...
     */
    public UnlockAbilityTrigger(ResourceLocation parRL)
    {
        super();
        RL = parRL;
    }
     ...
     */
    @Override
    public void addListener(PlayerAdvancements playerAdvancementsIn, Listener<UnlockAbilityTrigger.Instance> listener)
    {
        UnlockAbilityTrigger.Listeners myCustomTrigger$listeners = listeners.get(playerAdvancementsIn);

        if (myCustomTrigger$listeners == null)
        {
            myCustomTrigger$listeners = new UnlockAbilityTrigger.Listeners(playerAdvancementsIn);
     ...
     */
    @Override
    public void removeListener(PlayerAdvancements playerAdvancementsIn, Listener<UnlockAbilityTrigger.Instance> listener)
    {
        UnlockAbilityTrigger.Listeners tameanimaltrigger$listeners = listeners.get(playerAdvancementsIn);
    ...
    static class Listeners
    {
        ...
        private final Set<Listener<UnlockAbilityTrigger.Instance>> listeners = Sets.newHashSet();
         ...
         */
        public void add(Listener<UnlockAbilityTrigger.Instance> listener)
        {
         ...
         * @param listener the listener
         */
        public void remove(Listener<UnlockAbilityTrigger.Instance> listener)
        {
        ...
        public void trigger(Ability ability)
        {
            ...
            if (list != null)
            {
                for (Listener<UnlockAbilityTrigger.Instance> listener1 : list)
                {
