...
public class AbilitySlipstream extends Ability {
    ...
    public void execute(AbilityContext ctx) {
        ...
        if (bender.consumeChi(STATS_CONFIG.chiSlipstream)) {
            ...
            int speedboost = abilityData.getLevel() - 1;
            entity.addPotionEffect(new PotionEffect(MobEffects.SPEED, 100, speedboost));
                ...
                data.getAbilityData("slipstream").addXp(xp);
                        ...
                        if (abilityData.isMasterPath(AbilityData.AbilityTreePath.FIRST)) {
                            ...
                            if (abilityData.isMasterPath(AbilityData.AbilityTreePath.SECOND)) {
                                ...
                                entity.addPotionEffect(new PotionEffect(MobEffects.SPEED, 200, speedboost));
