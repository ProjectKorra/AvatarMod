...
public abstract class StatusControl {
	...
	public static final StatusControl
			...
			SHOOT_AIR_BURST_1 = new StatCtrlShootAirburst(1),
			SHOOT_AIR_BURST_2 = new StatCtrlShootAirburst(2),
			SHOOT_AIR_BURST_3 = new StatCtrlShootAirburst(3),
			SHOOT_AIR_BURST_4 = new StatCtrlShootAirburst(4),
