...
import com.crowsofwar.avatar.bending.bending.custom.hyper.powermods.HyperFormPowerModifier;
...
public class AbilityHyperForm extends Ability {

    public AbilityHyperForm() {
        super(Hyperbending.ID, "hyper_form");
    }
