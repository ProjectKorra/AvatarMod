package com.crowsofwar.avatar.bending.bending.combustion.powermods;
...
public class CombustionAuraPower extends PowerRatingModifier {
    ...
    public double get(BendingContext ctx) {
        ...
        return Objects.requireNonNull(Abilities.get("combustion_aura")).getProperty(Ability.POWERRATING, abilityData).doubleValue();
