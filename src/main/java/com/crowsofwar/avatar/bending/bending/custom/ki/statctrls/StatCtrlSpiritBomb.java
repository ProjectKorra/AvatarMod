 ...
 * @author CrowsOfWar
 */
public class StatCtrlSpiritBomb extends StatusControl {

    private final boolean setting;

    public StatCtrlSpiritBomb(boolean setting) {
    ...
    public boolean execute(BendingContext ctx) {
        ...
        AbilitySpiritBomb bastion = (AbilitySpiritBomb) Abilities.get("spirit_bomb");

        if (data.hasBendingId(Kibending.ID) && bastion != null) {
            if (setting) {
